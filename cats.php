...
<body>
  ...
  $sql = "SELECT * FROM cats_products WHERE id IN (1, 2, 3, 4)";
  $result = mysqli_query($conn, $sql);
  ...
  $sql = "SELECT * FROM cats_products WHERE id IN (5, 6, 7, 8)";
  $result = mysqli_query($conn, $sql);
  $allProducts = mysqli_fetch_all($result, MYSQLI_ASSOC); 
      foreach ($allProducts as $product) {
      $id = $product['id'];
  ...
  $sql = "SELECT * FROM cats_products WHERE id IN (9, 10, 11, 12)";
  $result = mysqli_query($conn, $sql);
  $allProducts = mysqli_fetch_all($result, MYSQLI_ASSOC); 
      foreach ($allProducts as $product) {
      $id = $product['id'];
